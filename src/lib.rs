#![no_std]
#![doc = "Peripheral access API (generated using svd2rust v0.17.0 (678c072 2021-03-12))"]
...
pub const UART0: uart::Uart0 = uart::Uart0(0x4003_4000 as u32 as _);
pub const UART1: uart::Uart0 = uart::Uart0(0x4003_8000 as u32 as _);
pub const SPI0: spi::Spi0 = spi::Spi0(0x4003_c000 as u32 as _);
pub const SPI1: spi::Spi0 = spi::Spi0(0x4004_0000 as u32 as _);
#[doc = "DW_apb_i2c address block"]
pub const I2C0: i2c::I2c0 = i2c::I2c0(0x4004_4000 as u32 as _);
pub const I2C1: i2c::I2c0 = i2c::I2c0(0x4004_8000 as u32 as _);
