...
impl ClkAdcCtrl {
    ...
    pub const fn auxsrc(&self) -> super::values::ClkAdcCtrlAuxsrc {
        let val = (self.0 >> 5u32) & 0x07;
        super::values::ClkAdcCtrlAuxsrc::from_bits(val as u8)
    }
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub fn set_auxsrc(&mut self, val: super::values::ClkAdcCtrlAuxsrc) {
...
impl ClkGpout3Ctrl {
    ...
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub const fn auxsrc(&self) -> super::values::ClkGpout3CtrlAuxsrc {
        let val = (self.0 >> 5u32) & 0x0f;
        super::values::ClkGpout3CtrlAuxsrc::from_bits(val as u8)
    }
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub fn set_auxsrc(&mut self, val: super::values::ClkGpout3CtrlAuxsrc) {
...
impl ClkPeriCtrl {
    ...
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub const fn auxsrc(&self) -> super::values::ClkPeriCtrlAuxsrc {
        let val = (self.0 >> 5u32) & 0x07;
        super::values::ClkPeriCtrlAuxsrc::from_bits(val as u8)
    }
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub fn set_auxsrc(&mut self, val: super::values::ClkPeriCtrlAuxsrc) {
        self.0 = (self.0 & !(0x07 << 5u32)) | (((val.to_bits() as u32) & 0x07) << 5u32);
    }
}
#[doc = "Clock control, can be changed on-the-fly (except for auxsrc)"]
...
impl ClkSysCtrl {
    ...
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub const fn auxsrc(&self) -> super::values::ClkSysCtrlAuxsrc {
        let val = (self.0 >> 5u32) & 0x07;
        super::values::ClkSysCtrlAuxsrc::from_bits(val as u8)
    }
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub fn set_auxsrc(&mut self, val: super::values::ClkSysCtrlAuxsrc) {
        self.0 = (self.0 & !(0x07 << 5u32)) | (((val.to_bits() as u32) & 0x07) << 5u32);
    }
    #[doc = "Selects the clock source glitchlessly, can be changed on-the-fly"]
    pub const fn src(&self) -> super::values::ClkSysCtrlSrc {
        let val = (self.0 >> 0u32) & 0x01;
        super::values::ClkSysCtrlSrc::from_bits(val as u8)
    }
    #[doc = "Selects the clock source glitchlessly, can be changed on-the-fly"]
    pub fn set_src(&mut self, val: super::values::ClkSysCtrlSrc) {
...
impl ClkRtcCtrl {
    ...
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub const fn auxsrc(&self) -> super::values::ClkRtcCtrlAuxsrc {
        let val = (self.0 >> 5u32) & 0x07;
        super::values::ClkRtcCtrlAuxsrc::from_bits(val as u8)
    }
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub fn set_auxsrc(&mut self, val: super::values::ClkRtcCtrlAuxsrc) {
        self.0 = (self.0 & !(0x07 << 5u32)) | (((val.to_bits() as u32) & 0x07) << 5u32);
    }
}
...
impl ClkRefCtrl {
    ...
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub const fn auxsrc(&self) -> super::values::ClkRefCtrlAuxsrc {
        let val = (self.0 >> 5u32) & 0x03;
        super::values::ClkRefCtrlAuxsrc::from_bits(val as u8)
    }
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub fn set_auxsrc(&mut self, val: super::values::ClkRefCtrlAuxsrc) {
        self.0 = (self.0 & !(0x03 << 5u32)) | (((val.to_bits() as u32) & 0x03) << 5u32);
    }
    #[doc = "Selects the clock source glitchlessly, can be changed on-the-fly"]
    pub const fn src(&self) -> super::values::ClkRefCtrlSrc {
        let val = (self.0 >> 0u32) & 0x03;
        super::values::ClkRefCtrlSrc::from_bits(val as u8)
    }
    #[doc = "Selects the clock source glitchlessly, can be changed on-the-fly"]
    pub fn set_src(&mut self, val: super::values::ClkRefCtrlSrc) {
...
impl ClkGpout1Ctrl {
    ...
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub const fn auxsrc(&self) -> super::values::ClkGpout1CtrlAuxsrc {
        let val = (self.0 >> 5u32) & 0x0f;
        super::values::ClkGpout1CtrlAuxsrc::from_bits(val as u8)
    }
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub fn set_auxsrc(&mut self, val: super::values::ClkGpout1CtrlAuxsrc) {
        self.0 = (self.0 & !(0x0f << 5u32)) | (((val.to_bits() as u32) & 0x0f) << 5u32);
    }
}
...
impl ClkGpout0Ctrl {
    ...
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub const fn auxsrc(&self) -> super::values::ClkGpout0CtrlAuxsrc {
        let val = (self.0 >> 5u32) & 0x0f;
        super::values::ClkGpout0CtrlAuxsrc::from_bits(val as u8)
    }
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub fn set_auxsrc(&mut self, val: super::values::ClkGpout0CtrlAuxsrc) {
        self.0 = (self.0 & !(0x0f << 5u32)) | (((val.to_bits() as u32) & 0x0f) << 5u32);
    }
}
...
impl ClkGpout2Ctrl {
    ...
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub const fn auxsrc(&self) -> super::values::ClkGpout2CtrlAuxsrc {
        let val = (self.0 >> 5u32) & 0x0f;
        super::values::ClkGpout2CtrlAuxsrc::from_bits(val as u8)
    }
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub fn set_auxsrc(&mut self, val: super::values::ClkGpout2CtrlAuxsrc) {
        self.0 = (self.0 & !(0x0f << 5u32)) | (((val.to_bits() as u32) & 0x0f) << 5u32);
    }
}
...
impl Fc0Src {
    ...
    pub const fn fc0_src(&self) -> super::values::Fc0SrcFc0Src {
        let val = (self.0 >> 0u32) & 0xff;
        super::values::Fc0SrcFc0Src::from_bits(val as u8)
    }
    pub fn set_fc0_src(&mut self, val: super::values::Fc0SrcFc0Src) {
...
impl ClkUsbCtrl {
    ...
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub const fn auxsrc(&self) -> super::values::ClkUsbCtrlAuxsrc {
        let val = (self.0 >> 5u32) & 0x07;
        super::values::ClkUsbCtrlAuxsrc::from_bits(val as u8)
    }
    #[doc = "Selects the auxiliary clock source, will glitch when switching"]
    pub fn set_auxsrc(&mut self, val: super::values::ClkUsbCtrlAuxsrc) {
        self.0 = (self.0 & !(0x07 << 5u32)) | (((val.to_bits() as u32) & 0x07) << 5u32);
    }
}
