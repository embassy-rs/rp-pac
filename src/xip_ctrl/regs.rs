...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct StreamCtr(u32);
impl StreamCtr {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> StreamCtr {
        StreamCtr(val)
    }
...
impl Stat {
    ...
    pub const fn from_bits(val: u32) -> Stat {
        Stat(val)
    }
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct Flush(u32);
impl Flush {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> Flush {
        Flush(val)
    }
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct StreamAddr(u32);
impl StreamAddr {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> StreamAddr {
        StreamAddr(val)
    }
