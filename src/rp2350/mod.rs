#![no_std]
#![doc = "Peripheral access API (generated using chiptool v0.1.0 (d290630 2023-06-29))"]
...
pub const SYSCFG: syscfg::Syscfg = unsafe { syscfg::Syscfg::from_ptr(0x4000_8000 as usize as _) };
pub const CLOCKS: clocks::Clocks = unsafe { clocks::Clocks::from_ptr(0x4001_0000 as usize as _) };
pub const PSM: psm::Psm = unsafe { psm::Psm::from_ptr(0x4001_8000 as usize as _) };
pub const RESETS: resets::Resets = unsafe { resets::Resets::from_ptr(0x4002_0000 as usize as _) };
pub const IO_BANK0: io::Io = unsafe { io::Io::from_ptr(0x4002_8000 as usize as _) };
pub const IO_QSPI: io::Io = unsafe { io::Io::from_ptr(0x4003_0000 as usize as _) };
pub const PADS_BANK0: pads::Pads = unsafe { pads::Pads::from_ptr(0x4003_8000 as usize as _) };
pub const PADS_QSPI: pads::Pads = unsafe { pads::Pads::from_ptr(0x4004_0000 as usize as _) };
#[doc = "Controls the crystal oscillator"]
pub const XOSC: xosc::Xosc = unsafe { xosc::Xosc::from_ptr(0x4004_8000 as usize as _) };
pub const PLL_SYS: pll::Pll = unsafe { pll::Pll::from_ptr(0x4005_0000 as usize as _) };
pub const PLL_USB: pll::Pll = unsafe { pll::Pll::from_ptr(0x4005_8000 as usize as _) };
#[doc = "Hardware access control registers"]
pub const ACCESSCTRL: accessctrl::Accessctrl =
    unsafe { accessctrl::Accessctrl::from_ptr(0x4006_0000 as usize as _) };
#[doc = "Register block for busfabric control signals and performance counters"]
pub const BUSCTRL: busctrl::Busctrl =
    unsafe { busctrl::Busctrl::from_ptr(0x4006_8000 as usize as _) };
pub const UART0: uart::Uart = unsafe { uart::Uart::from_ptr(0x4007_0000 as usize as _) };
pub const UART1: uart::Uart = unsafe { uart::Uart::from_ptr(0x4007_8000 as usize as _) };
pub const SPI0: spi::Spi = unsafe { spi::Spi::from_ptr(0x4008_0000 as usize as _) };
pub const SPI1: spi::Spi = unsafe { spi::Spi::from_ptr(0x4008_8000 as usize as _) };
...
pub const I2C0: i2c::I2c = unsafe { i2c::I2c::from_ptr(0x4009_0000 as usize as _) };
pub const I2C1: i2c::I2c = unsafe { i2c::I2c::from_ptr(0x4009_8000 as usize as _) };
#[doc = "Control and data interface to SAR ADC"]
pub const ADC: adc::Adc = unsafe { adc::Adc::from_ptr(0x400a_0000 as usize as _) };
#[doc = "Simple PWM"]
pub const PWM: pwm::Pwm = unsafe { pwm::Pwm::from_ptr(0x400a_8000 as usize as _) };
...
pub const TIMER0: timer::Timer = unsafe { timer::Timer::from_ptr(0x400b_0000 as usize as _) };
pub const TIMER1: timer::Timer = unsafe { timer::Timer::from_ptr(0x400b_8000 as usize as _) };
...
pub const HSTX_CTRL: hstx_ctrl::HstxCtrl =
    unsafe { hstx_ctrl::HstxCtrl::from_ptr(0x400c_0000 as usize as _) };
#[doc = "QSPI flash execute-in-place block"]
pub const XIP_CTRL: xip_ctrl::XipCtrl =
    unsafe { xip_ctrl::XipCtrl::from_ptr(0x400c_8000 as usize as _) };
...
pub const QMI: qmi::Qmi = unsafe { qmi::Qmi::from_ptr(0x400d_0000 as usize as _) };
pub const WATCHDOG: watchdog::Watchdog =
    unsafe { watchdog::Watchdog::from_ptr(0x400d_8000 as usize as _) };
#[doc = "Additional registers mapped adjacent to the bootram, for use by the bootrom."]
pub const BOOTRAM: bootram::Bootram =
    unsafe { bootram::Bootram::from_ptr(0x400e_0000 as usize as _) };
pub const ROSC: rosc::Rosc = unsafe { rosc::Rosc::from_ptr(0x400e_8000 as usize as _) };
#[doc = "ARM TrustZone RNG register block"]
pub const TRNG: trng::Trng = unsafe { trng::Trng::from_ptr(0x400f_0000 as usize as _) };
#[doc = "SHA-256 hash function implementation"]
pub const SHA256: sha256::Sha256 = unsafe { sha256::Sha256::from_ptr(0x400f_8000 as usize as _) };
...
pub const POWMAN: powman::Powman = unsafe { powman::Powman::from_ptr(0x4010_0000 as usize as _) };
pub const TICKS: ticks::Ticks = unsafe { ticks::Ticks::from_ptr(0x4010_8000 as usize as _) };
#[doc = "SNPS OTP control IF (SBPI and RPi wrapper control)"]
pub const OTP: otp::Otp = unsafe { otp::Otp::from_ptr(0x4012_0000 as usize as _) };
#[doc = "Predefined OTP data layout for RP2350"]
pub const OTP_DATA: otp_data::OtpData =
    unsafe { otp_data::OtpData::from_ptr(0x4013_0000 as usize as _) };
#[doc = "Predefined OTP data layout for RP2350"]
pub const OTP_DATA_RAW: otp_data_raw::OtpDataRaw =
    unsafe { otp_data_raw::OtpDataRaw::from_ptr(0x4013_4000 as usize as _) };
#[doc = "Glitch detector controls"]
pub const GLITCH_DETECTOR: glitch_detector::GlitchDetector =
    unsafe { glitch_detector::GlitchDetector::from_ptr(0x4015_8000 as usize as _) };
#[doc = "For managing simulation testbenches"]
pub const TBMAN: tbman::Tbman = unsafe { tbman::Tbman::from_ptr(0x4016_0000 as usize as _) };
...
pub const USB: usb::Usb = unsafe { usb::Usb::from_ptr(0x5011_0000 as usize as _) };
...
pub const PIO2: pio::Pio = unsafe { pio::Pio::from_ptr(0x5040_0000 as usize as _) };
#[doc = "Auxiliary DMA access to XIP FIFOs, via fast AHB bus access"]
pub const XIP_AUX: xip_aux::XipAux =
    unsafe { xip_aux::XipAux::from_ptr(0x5050_0000 as usize as _) };
#[doc = "FIFO status and write access for HSTX"]
pub const HSTX_FIFO: hstx_fifo::HstxFifo =
    unsafe { hstx_fifo::HstxFifo::from_ptr(0x5060_0000 as usize as _) };
#[doc = "Coresight block - RP specific registers"]
pub const CORESIGHT_TRACE: coresight_trace::CoresightTrace =
    unsafe { coresight_trace::CoresightTrace::from_ptr(0x5070_0000 as usize as _) };
...
pub const SIO_NS: sio::Sio = unsafe { sio::Sio::from_ptr(0xd002_0000 as usize as _) };
#[doc = "Cortex-M33 EPPB vendor register block for RP2350"]
pub const EPPB: eppb::Eppb = unsafe { eppb::Eppb::from_ptr(0xe008_0000 as usize as _) };
