...
impl Ctrlr0 {
    ...
    pub const fn spi_frf(&self) -> super::values::Ctrlr0SpiFrf {
        let val = (self.0 >> 21u32) & 0x03;
        super::values::Ctrlr0SpiFrf::from_bits(val as u8)
    }
    #[doc = "SPI frame format"]
    pub fn set_spi_frf(&mut self, val: super::values::Ctrlr0SpiFrf) {
    ...
    #[doc = "Transfer mode"]
    pub const fn tmod(&self) -> super::values::Ctrlr0Tmod {
        let val = (self.0 >> 8u32) & 0x03;
        super::values::Ctrlr0Tmod::from_bits(val as u8)
    }
    #[doc = "Transfer mode"]
    pub fn set_tmod(&mut self, val: super::values::Ctrlr0Tmod) {
...
impl SpiCtrlr0 {
    ...
    pub const fn inst_l(&self) -> super::values::SpiCtrlr0InstL {
        let val = (self.0 >> 8u32) & 0x03;
        super::values::SpiCtrlr0InstL::from_bits(val as u8)
    }
    #[doc = "Instruction length (0/4/8/16b)"]
    pub fn set_inst_l(&mut self, val: super::values::SpiCtrlr0InstL) {
        self.0 = (self.0 & !(0x03 << 8u32)) | (((val.to_bits() as u32) & 0x03) << 8u32);
    }
    ...
    pub const fn trans_type(&self) -> super::values::SpiCtrlr0TransType {
        let val = (self.0 >> 0u32) & 0x03;
        super::values::SpiCtrlr0TransType::from_bits(val as u8)
    }
    #[doc = "Address and instruction transfer format"]
    pub fn set_trans_type(&mut self, val: super::values::SpiCtrlr0TransType) {
