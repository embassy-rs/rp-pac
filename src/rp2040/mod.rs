...
pub const XIP_CTRL: xip_ctrl::XipCtrl =
    unsafe { xip_ctrl::XipCtrl::from_ptr(0x1400_0000usize as _) };
...
pub const SSI: ssi::Ssi = unsafe { ssi::Ssi::from_ptr(0x1800_0000usize as _) };
...
pub const SYSCFG: syscfg::Syscfg = unsafe { syscfg::Syscfg::from_ptr(0x4000_4000usize as _) };
pub const CLOCKS: clocks::Clocks = unsafe { clocks::Clocks::from_ptr(0x4000_8000usize as _) };
pub const RESETS: resets::Resets = unsafe { resets::Resets::from_ptr(0x4000_c000usize as _) };
pub const PSM: psm::Psm = unsafe { psm::Psm::from_ptr(0x4001_0000usize as _) };
pub const IO_BANK0: io::Io = unsafe { io::Io::from_ptr(0x4001_4000usize as _) };
pub const IO_QSPI: io::Io = unsafe { io::Io::from_ptr(0x4001_8000usize as _) };
pub const PADS_BANK0: pads::Pads = unsafe { pads::Pads::from_ptr(0x4001_c000usize as _) };
pub const PADS_QSPI: pads::Pads = unsafe { pads::Pads::from_ptr(0x4002_0000usize as _) };
#[doc = "Controls the crystal oscillator"]
pub const XOSC: xosc::Xosc = unsafe { xosc::Xosc::from_ptr(0x4002_4000usize as _) };
pub const PLL_SYS: pll::Pll = unsafe { pll::Pll::from_ptr(0x4002_8000usize as _) };
pub const PLL_USB: pll::Pll = unsafe { pll::Pll::from_ptr(0x4002_c000usize as _) };
#[doc = "Register block for busfabric control signals and performance counters"]
pub const BUSCTRL: busctrl::Busctrl = unsafe { busctrl::Busctrl::from_ptr(0x4003_0000usize as _) };
pub const UART0: uart::Uart = unsafe { uart::Uart::from_ptr(0x4003_4000usize as _) };
pub const UART1: uart::Uart = unsafe { uart::Uart::from_ptr(0x4003_8000usize as _) };
pub const SPI0: spi::Spi = unsafe { spi::Spi::from_ptr(0x4003_c000usize as _) };
pub const SPI1: spi::Spi = unsafe { spi::Spi::from_ptr(0x4004_0000usize as _) };
...
pub const I2C0: i2c::I2c = unsafe { i2c::I2c::from_ptr(0x4004_4000usize as _) };
pub const I2C1: i2c::I2c = unsafe { i2c::I2c::from_ptr(0x4004_8000usize as _) };
#[doc = "Control and data interface to SAR ADC"]
pub const ADC: adc::Adc = unsafe { adc::Adc::from_ptr(0x4004_c000usize as _) };
#[doc = "Simple PWM"]
pub const PWM: pwm::Pwm = unsafe { pwm::Pwm::from_ptr(0x4005_0000usize as _) };
...
pub const TIMER: timer::Timer = unsafe { timer::Timer::from_ptr(0x4005_4000usize as _) };
pub const WATCHDOG: watchdog::Watchdog =
    unsafe { watchdog::Watchdog::from_ptr(0x4005_8000usize as _) };
#[doc = "Register block to control RTC"]
pub const RTC: rtc::Rtc = unsafe { rtc::Rtc::from_ptr(0x4005_c000usize as _) };
pub const ROSC: rosc::Rosc = unsafe { rosc::Rosc::from_ptr(0x4006_0000usize as _) };
...
pub const VREG_AND_CHIP_RESET: vreg_and_chip_reset::VregAndChipReset =
    unsafe { vreg_and_chip_reset::VregAndChipReset::from_ptr(0x4006_4000usize as _) };
#[doc = "Testbench manager. Allows the programmer to know what platform their software is running on."]
pub const TBMAN: tbman::Tbman = unsafe { tbman::Tbman::from_ptr(0x4006_c000usize as _) };
