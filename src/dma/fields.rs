...
impl Ch11CtrlTrig {
    ...
    pub const fn treq_sel(&self) -> super::values::TreqSel {
        let val = (self.0 >> 15u32) & 0x3f;
        super::values::TreqSel::from_bits(val as u8)
    }
    #[doc = "Select a Transfer Request signal. The channel uses the transfer request signal to pace its data transfer rate. Sources for TREQ signals are internal (TIMERS) or external (DREQ, a Data Request from the system). 0x0 to 0x3a -> select DREQ n as TREQ"]
    pub fn set_treq_sel(&mut self, val: super::values::TreqSel) {
    ...
    pub const fn data_size(&self) -> super::values::DataSize {
        let val = (self.0 >> 2u32) & 0x03;
        super::values::DataSize::from_bits(val as u8)
    }
    #[doc = "Set the size of each bus transfer (byte/halfword/word). READ_ADDR and WRITE_ADDR advance by this amount (1/2/4 bytes) with each transfer."]
    pub fn set_data_size(&mut self, val: super::values::DataSize) {
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct Timer1(u32);
impl Timer1 {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> Timer1 {
        Timer1(val)
    }
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct Timer0(u32);
impl Timer0 {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> Timer0 {
        Timer0(val)
    }
    #[doc = "Pacing Timer Dividend. Specifies the X value for the (X/Y) fractional timer."]
    pub const fn x(&self) -> u16 {
...
impl SniffCtrl {
    ...
    pub const fn calc(&self) -> super::values::SniffCtrlCalc {
        let val = (self.0 >> 5u32) & 0x0f;
        super::values::SniffCtrlCalc::from_bits(val as u8)
    }
    pub fn set_calc(&mut self, val: super::values::SniffCtrlCalc) {
