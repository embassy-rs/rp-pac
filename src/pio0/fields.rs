...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct Flevel(u32);
impl Flevel {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> Flevel {
        Flevel(val)
    }
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct DbgCfginfo(u32);
impl DbgCfginfo {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> DbgCfginfo {
        DbgCfginfo(val)
    }
...
impl Irq {
    ...
    pub const fn from_bits(val: u32) -> Irq {
        Irq(val)
    }
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct SmPinctrl(u32);
impl SmPinctrl {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> SmPinctrl {
        SmPinctrl(val)
    }
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct Fdebug(u32);
impl Fdebug {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> Fdebug {
        Fdebug(val)
    }
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct SmShiftctrl(u32);
impl SmShiftctrl {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> SmShiftctrl {
        SmShiftctrl(val)
    }
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct IrqForce(u32);
impl IrqForce {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> IrqForce {
        IrqForce(val)
    }
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct SmExecctrl(u32);
impl SmExecctrl {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> SmExecctrl {
        SmExecctrl(val)
    }
    ...
    pub const fn status_sel(&self) -> super::values::SmExecctrlStatusSel {
        let val = (self.0 >> 4u32) & 0x01;
        super::values::SmExecctrlStatusSel::from_bits(val as u8)
    }
    #[doc = "Comparison used for the MOV x, STATUS instruction."]
    pub fn set_status_sel(&mut self, val: super::values::SmExecctrlStatusSel) {
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct Fstat(u32);
impl Fstat {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> Fstat {
        Fstat(val)
    }
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct SmClkdiv(u32);
impl SmClkdiv {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> SmClkdiv {
        SmClkdiv(val)
    }
...
#[doc = "Instruction currently being executed by state machine 3 Write to execute an instruction immediately (including jumps) and then resume execution."]
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct SmInstr(u32);
impl SmInstr {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> SmInstr {
        SmInstr(val)
    }
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct SmAddr(u32);
impl SmAddr {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> SmAddr {
        SmAddr(val)
    }
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct InstrMem(u32);
impl InstrMem {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> InstrMem {
        InstrMem(val)
    }
