...
impl Done {
    ...
    pub const fn from_bits(val: u32) -> Done {
        Done(val)
    }
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct FrceOff(u32);
impl FrceOff {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> FrceOff {
        FrceOff(val)
    }
    pub const fn proc1(&self) -> bool {
        let val = (self.0 >> 16u32) & 0x01;
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct FrceOn(u32);
impl FrceOn {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> FrceOn {
        FrceOn(val)
    }
    pub const fn proc1(&self) -> bool {
        let val = (self.0 >> 16u32) & 0x01;
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct Wdsel(u32);
impl Wdsel {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> Wdsel {
        Wdsel(val)
    }
    pub const fn proc1(&self) -> bool {
        let val = (self.0 >> 16u32) & 0x01;
