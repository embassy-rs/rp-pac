...
impl Phase {
    ...
    pub const fn from_bits(val: u32) -> Phase {
        Phase(val)
    }
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct Randombit(u32);
impl Randombit {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> Randombit {
        Randombit(val)
    }
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct Freqb(u32);
impl Freqb {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> Freqb {
        Freqb(val)
    }
    #[doc = "Set to 0x9696 to apply the settings Any other value in this field will set all drive strengths to 0"]
    pub const fn passwd(&self) -> super::values::Passwd {
        let val = (self.0 >> 16u32) & 0xffff;
        super::values::Passwd::from_bits(val as u16)
    }
    #[doc = "Set to 0x9696 to apply the settings Any other value in this field will set all drive strengths to 0"]
    pub fn set_passwd(&mut self, val: super::values::Passwd) {
        self.0 = (self.0 & !(0xffff << 16u32)) | (((val.to_bits() as u32) & 0xffff) << 16u32);
    }
...
#[repr(transparent)]
#[derive(Copy, Clone)]
pub struct Freqa(u32);
impl Freqa {
    pub const fn to_bits(&self) -> u32 {
        self.0
    }
    pub const fn from_bits(val: u32) -> Freqa {
        Freqa(val)
    }
    #[doc = "Set to 0x9696 to apply the settings Any other value in this field will set all drive strengths to 0"]
    pub const fn passwd(&self) -> super::values::Passwd {
...
impl Div {
    ...
    pub const fn div(&self) -> super::values::DivDiv {
        let val = (self.0 >> 0u32) & 0x0fff;
        super::values::DivDiv::from_bits(val as u16)
    }
    #[doc = "set to 0xaa0 + div where div = 0 divides by 32 div = 1-31 divides by div any other value sets div=0 and therefore divides by 32 this register resets to div=16"]
    pub fn set_div(&mut self, val: super::values::DivDiv) {
        self.0 = (self.0 & !(0x0fff << 0u32)) | (((val.to_bits() as u32) & 0x0fff) << 0u32);
    }
}
