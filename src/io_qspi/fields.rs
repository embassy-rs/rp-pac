...
impl GpioQspiSclkCtrl {
    ...
    pub const fn funcsel(&self) -> super::values::GpioQspiSclkCtrlFuncsel {
        let val = (self.0 >> 0u32) & 0x1f;
        super::values::GpioQspiSclkCtrlFuncsel::from_bits(val as u8)
    }
    #[doc = "0-31 -> selects pin function according to the gpio table 31 == NULL"]
    pub fn set_funcsel(&mut self, val: super::values::GpioQspiSclkCtrlFuncsel) {
...
impl GpioQspiSd3Ctrl {
    ...
    #[doc = "0-31 -> selects pin function according to the gpio table 31 == NULL"]
    pub const fn funcsel(&self) -> super::values::GpioQspiSd3CtrlFuncsel {
        let val = (self.0 >> 0u32) & 0x1f;
        super::values::GpioQspiSd3CtrlFuncsel::from_bits(val as u8)
    }
    #[doc = "0-31 -> selects pin function according to the gpio table 31 == NULL"]
    pub fn set_funcsel(&mut self, val: super::values::GpioQspiSd3CtrlFuncsel) {
        self.0 = (self.0 & !(0x1f << 0u32)) | (((val.to_bits() as u32) & 0x1f) << 0u32);
    }
}
#[doc = "GPIO control including function select and overrides."]
...
impl GpioQspiSd1Ctrl {
    ...
    #[doc = "0-31 -> selects pin function according to the gpio table 31 == NULL"]
    pub const fn funcsel(&self) -> super::values::GpioQspiSd1CtrlFuncsel {
        let val = (self.0 >> 0u32) & 0x1f;
        super::values::GpioQspiSd1CtrlFuncsel::from_bits(val as u8)
    }
    #[doc = "0-31 -> selects pin function according to the gpio table 31 == NULL"]
    pub fn set_funcsel(&mut self, val: super::values::GpioQspiSd1CtrlFuncsel) {
        self.0 = (self.0 & !(0x1f << 0u32)) | (((val.to_bits() as u32) & 0x1f) << 0u32);
    }
}
#[doc = "GPIO control including function select and overrides."]
...
impl GpioQspiSsCtrl {
    ...
    #[doc = "0-31 -> selects pin function according to the gpio table 31 == NULL"]
    pub const fn funcsel(&self) -> super::values::GpioQspiSsCtrlFuncsel {
        let val = (self.0 >> 0u32) & 0x1f;
        super::values::GpioQspiSsCtrlFuncsel::from_bits(val as u8)
    }
    #[doc = "0-31 -> selects pin function according to the gpio table 31 == NULL"]
    pub fn set_funcsel(&mut self, val: super::values::GpioQspiSsCtrlFuncsel) {
        self.0 = (self.0 & !(0x1f << 0u32)) | (((val.to_bits() as u32) & 0x1f) << 0u32);
    }
}
#[doc = "GPIO status"]
...
impl GpioQspiSd2Ctrl {
    ...
    #[doc = "0-31 -> selects pin function according to the gpio table 31 == NULL"]
    pub const fn funcsel(&self) -> super::values::GpioQspiSd2CtrlFuncsel {
        let val = (self.0 >> 0u32) & 0x1f;
        super::values::GpioQspiSd2CtrlFuncsel::from_bits(val as u8)
    }
    #[doc = "0-31 -> selects pin function according to the gpio table 31 == NULL"]
    pub fn set_funcsel(&mut self, val: super::values::GpioQspiSd2CtrlFuncsel) {
        self.0 = (self.0 & !(0x1f << 0u32)) | (((val.to_bits() as u32) & 0x1f) << 0u32);
    }
}
#[doc = "GPIO status"]
...
impl GpioQspiSd0Ctrl {
    ...
    #[doc = "0-31 -> selects pin function according to the gpio table 31 == NULL"]
    pub const fn funcsel(&self) -> super::values::GpioQspiSd0CtrlFuncsel {
        let val = (self.0 >> 0u32) & 0x1f;
        super::values::GpioQspiSd0CtrlFuncsel::from_bits(val as u8)
    }
    #[doc = "0-31 -> selects pin function according to the gpio table 31 == NULL"]
    pub fn set_funcsel(&mut self, val: super::values::GpioQspiSd0CtrlFuncsel) {
        self.0 = (self.0 & !(0x1f << 0u32)) | (((val.to_bits() as u32) & 0x1f) << 0u32);
    }
}
#[doc = "GPIO status"]
